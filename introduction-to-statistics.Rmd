...
Total sum of differences among the mean and the observations is zero
...
However, arithmetic mean equals 20/3.
...
The average difference among the observations and the mean (?)
...
Variance is simple the square of standard deviation.
