...
.pull-right[
```{r}
include_graphics("introduction-to-r_files/demography.gif")
```
]
...
If you combine characters, you can convert this vector to **factor** type. This is useful if we can enclose an order to the vector or we want to control for the possible values.
