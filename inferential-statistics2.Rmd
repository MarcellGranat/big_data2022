...
```{r}
read_html("https://finance.yahoo.com/quote/ES%3DF/history?period1=1507075200&period2=1664755205&interval=1d&filter=history&frequency=1d&includeAdjustedClose=true") %>% 
    html_table()
```
